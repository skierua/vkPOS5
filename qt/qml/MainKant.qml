    ...
    function openConnection(vname, vdriver){
        ...
        if (!va.errid){
            ...
            if(aa) { root.acnts = aa;/* Lib.log('#671g acnts='+JSON.stringify(root.acnts));*/}
                ...
                root.acnts = { "cash":"3000", "incas":"3003", "trade":"3500", "bulk":"3501", "profit":"3607-55" }
                Lib.log('#25tx acnts JSON.parse error');
            }
...
//        msg("#84r onClosing")
    ...
    Component.onCompleted: {
        ...
        // Lib.log("2ue "+root.bindList)
        // Lib.log(Qt.atob("s7d8"))
        // winTaxServiceAction.enabled = ~root.bindList.indexOf("tax")
        // pageFactureAction.enabled = ~vbinds.indexOf("facture")
        pageIncasAction.enabled = ~root.bindList.indexOf("incas")
